...
client_id = "43980685061-m0cggsenk24bupco73k863j996nfr3t1.apps.googleusercontent.com"
client_secret = "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"

#redirect_uri = "https://hawkcase-cs493-portfolio.uc.r.appspot.com/oauth"
...
def oauthroute():
	...
	if len(result) == 0:
		...
		#person = requests.get("https://people.googleapis.com/v1/people/me?personFields=names&access_token=" + token).json()
		#return render_template('oauth.html', data=person, token=token['id_token'], sub=id_info['sub'])
